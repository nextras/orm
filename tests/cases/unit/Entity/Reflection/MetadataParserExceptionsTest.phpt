...
class MetadataParserExceptionsTest extends TestCase
{
	public function testOneHasMany()
	{
		...
		Assert::throws(function () use ($parser) {
			$parser->parseEntity(EdgeCasesMetadataParserEntity1::class, $dep);
		}, InvalidStateException::class); // missing primary modifier

		Assert::throws(function () use ($parser) {
			$parser->parseEntity(EdgeCasesMetadataParserEntity4::class, $dep);
		...
		Assert::throws(function () use ($parser) {
			$parser->parseEntity(EdgeCasesMetadataParserEntity5::class, $dep);
		...
		Assert::throws(function () use ($parser) {
			$parser->parseEntity(EdgeCasesMetadataParserEntity6::class, $dep);
		...
		Assert::throws(function () use ($parser) {
			$parser->parseEntity(EdgeCasesMetadataParserEntity7::class, $dep);
		...
		Assert::throws(function () use ($parser) {
			$parser->parseEntity(EdgeCasesMetadataParserEntity8::class, $dep);
	...
	public function testWrongArguments()
	{
		...
		Assert::throws(function () use ($parser) {
			$parser->parseEntity(EdgeCasesMetadataParserEntity9::class, $dep);
		...
		Assert::throws(function () use ($parser) {
			$parser->parseEntity(EdgeCasesMetadataParserEntity10::class, $dep);
