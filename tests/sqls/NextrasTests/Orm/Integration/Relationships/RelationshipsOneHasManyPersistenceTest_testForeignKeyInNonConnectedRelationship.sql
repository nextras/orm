...
INSERT INTO "users_x_users" ("friends_with_me_id", "my_friends_id") VALUES (2, 1);
COMMIT;
SELECT
...
START TRANSACTION;
DELETE FROM "users_x_users" WHERE ("friends_with_me_id", "my_friends_id") IN ((2, 1));
...
WHERE
  "users_x_users"."my_friends_id" IN (1, 2);
