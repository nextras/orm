...
START TRANSACTION;
INSERT INTO "tags" ("name", "is_global", "count") VALUES ('Testing Tag', 'y', 0);
SELECT CURRVAL('public.tags_id_seq');
INSERT INTO "books" ("title", "author_id", "translator_id", "next_part", "ean_id", "publisher_id", "genre", "published_at", "printed_at", "thread_id", "count", "price", "price_currency", "orig_price_cents", "orig_price_currency") VALUES ('The Wall', 1, 1, NULL, NULL, 1, 'fantasy', '2021-12-31 23:59:59.000000'::timestamp, NULL, NULL, 0, NULL, NULL, NULL, NULL);
...
START TRANSACTION;
INSERT INTO "books" ("title", "author_id", "translator_id", "next_part", "ean_id", "publisher_id", "genre", "published_at", "printed_at", "thread_id", "count", "price", "price_currency", "orig_price_cents", "orig_price_currency") VALUES ('The Wall III', 1, NULL, NULL, NULL, 1, 'fantasy', '2021-12-31 23:59:59.000000'::timestamp, NULL, NULL, 0, NULL, NULL, NULL, NULL);
SELECT CURRVAL('public.books_id_seq');
