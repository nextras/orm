...
SELECT "translator_id", COUNT(DISTINCT "count") as "count" FROM (SELECT "books"."translator_id", "books"."id" AS "count" FROM "books" AS "books" WHERE "books"."translator_id" IN (2)) AS "temp" GROUP BY "translator_id";
