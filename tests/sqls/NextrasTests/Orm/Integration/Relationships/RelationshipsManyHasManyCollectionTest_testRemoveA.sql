...
SELECT "publishers_x_tags"."publisher_id", "publishers_x_tags"."tag_id" FROM "publishers" AS "publishers" LEFT JOIN "publishers_x_tags" AS "publishers_x_tags" ON ("publishers_x_tags"."publisher_id" = "publishers"."publisher_id") WHERE "publishers_x_tags"."tag_id" IN (2);
